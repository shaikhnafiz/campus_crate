...
export const listingDescription = (listing) =>
  ...
  (listing.module === "lost"
    ...
    : listing.module === "market"
      ...
      : `${listing.title} available at ${listing.detail}. Located in ${listing.meta}, with easy transport to campus. Includes essential furniture, reliable water and electricity, and a quiet environment suited to studying.`);
...
export const listings = [
  ...
  { id: 5, module: "housing", title: "Furnished room near campus", detail: "৳6,500 / month", meta: "Dhanmondi · 0.8 km away", tag: "Room", status: "FEMALE", image: 4 },
  { id: 6, module: "housing", title: "Bright shared apartment", detail: "৳9,000 / month", meta: "Mohammadpur · 1.2 km away", tag: "Flat", status: "ANY", image: 5 },
  ...
  { id: 11, module: "housing", title: "Quiet mess seat", detail: "৳4,200 / month", meta: "Lalmatia · 1.5 km away", tag: "Mess seat", status: "MALE", image: 4 },
];
